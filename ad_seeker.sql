...
VALUES (1, 'Sonic the Hedgehog 2', 'Sonic 2, its good', '50.99', 'used', 'Sega Genesis', 'Action, platformer'),
       ...
       (1, 'Golden Sun', 'A classic on the GBA', '100.00', 'used', 'Gameboy Advanced', 'RPG, Adventure, Puzzle'),
       (1, 'Altered Beast', 'Altered beast', '69.99', 'used', 'Sega Genesis', 'Action, fantasy'),
       (1, 'Fable', 'Fable, classic RPG fantasy game where your choices matter', '35.75', 'used', 'Xbox', 'Action, adventure, RPG');
SELECT * FROM users;
SELECT * FROM ads;